...
//    private $extra_menu= $extra_menu_custom;
    ...
    <?php if ($enable_ongpage_option && 0 === $depth) : ?>
        ...
        <p class="description description-wide">
            <label for="menu-item-ct-menu-marker-<?php echo esc_attr($item_id); ?>">
                <?php esc_html_e('Marker', CT_TEXT_DOMAIN); ?><br/>
                <input type="text" min="0" id="menu-item-ct-menu-marker-<?php echo esc_attr($item_id); ?>"
                        class="widefat menu-item-ct-menu-marker"
                        name="menu-item-ct-menu-marker[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr($item->ct_menu_marker); ?>" />
            </label>
        </p>
        ...
        <p class="description description-wide">
            <label for="menu-item-ct-custom-class-<?php echo esc_attr($item_id); ?>">
                <?php esc_html_e('Custom class', CT_TEXT_DOMAIN); ?><br/>
