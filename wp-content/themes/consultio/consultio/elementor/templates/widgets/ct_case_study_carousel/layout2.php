...
$category_label = $widget->get_setting('category_label', '');
$category_label_tmp = '';
if(!empty($category_label)) {
    $category_label_tmp = $category_label;
} else {
    $category_label_tmp = esc_html('Category:', 'consultio');
}
                    ...
                    <div class="item--holder">
                        ...
                        <?php if($show_category == 'true') : ?>
                            <div class="item--category">
                                <?php the_terms( $post->ID, 'case-study-category', ' <label>'.$category_label_tmp.'</label> ', ', ' ); ?>
                            </div>
                        <?php endif; ?>
