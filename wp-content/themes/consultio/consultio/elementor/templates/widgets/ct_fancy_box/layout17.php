...
?>
<div class="ct-fancy-box ct-fancy-box-layout17 <?php echo esc_attr($settings['ct_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['ct_animate_delay']); ?>ms">
    ...
    <div class="item--holder-hover">
        ...
        <?php if ( ! empty( $settings['link']['url'] ) ) { ?>
            <a class="item--link" <?php ct_print_html($widget->get_render_attribute_string( 'button' )); ?>><i class="flaticonv2-right-arrow"></i></a>
        <?php } ?>
    </div>
