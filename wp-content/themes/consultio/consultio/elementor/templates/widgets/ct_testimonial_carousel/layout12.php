...
$style_l12 = $widget->get_setting('style_l12', 'style1');
...
<?php if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div class="ct-testimonial ct-testimonial-carousel12 ct-slick-slider <?php if($style_l12 == 'style1') { echo 'dot-style-u1'; } else { echo 'dot-style-u5'; } ?> <?php echo esc_attr($style_l12); ?>">
